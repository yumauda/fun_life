        ...
        <div class="l-inner">
            <div class="p-header__inner">
                ...
                <div class="p-header__actions">
                    ...
                    <button class="p-header__menu js-drawer-trigger" type="button" aria-label="メニューを開く" aria-controls="drawer" aria-expanded="false">
                        <span class="p-header__menu-text">MENU</span>
                        <span class="p-header__menu-bars" aria-hidden="true">
                            <span class="p-header__menu-bar p-header__menu-bar--short"></span>
                            <span class="p-header__menu-bar"></span>
                        </span>
                    </button>
                </div>
            </div>
